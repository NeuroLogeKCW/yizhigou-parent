...
public class GoodsController {
    ...
    public PageResult findPage(@RequestBody TbGoods tbGoods, int page, int rows) {
     ...
     */
    @RequestMapping("/add")
    public Result add(@RequestBody GoodsExt goods) {
        try {
    ...
    public Result update(@RequestBody GoodsExt goods) {
        try {
